...
class DeliveryInfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create delivery_info" do
    assert_difference('DeliveryInfo.count') do
      post delivery_infos_url, params: { delivery_info: { address: @delivery_info.address, phone: @delivery_info.phone, user_id: @delivery_info.user_id } }
    end
  ...
  test "should update delivery_info" do
    patch delivery_info_url(@delivery_info), params: { delivery_info: { address: @delivery_info.address, phone: @delivery_info.phone, user_id: @delivery_info.user_id } }
